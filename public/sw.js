const CACHE = 'ball-kho-gayi-xi-v8-home-shell';
const ASSETS = ['./','./index.html','./styles.css','./css/tokens.css','./css/app-shell.css','./css/screens/home.css','./js/router.js','./app.js','./manifest.json','./assets/cric-time-front.jpg','./assets/ball-kho-gayi-circle.png','./assets/logo-64.png','./assets/logo-192.png','./assets/logo-512.png','./assets/Ball-Kho-Gayi-XI-Player-Guide.pdf'];
